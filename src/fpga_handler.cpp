                   ...
                   std::vector<Motor> *motors_list)
{
    ...
    if (CAN_port_ == "MOD1CAN0")
    {
        ...
        r_tx_buf_id1_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlArrayU8_Mod1CAN0ID1TX;
        r_tx_buf_id2_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlArrayU8_Mod1CAN0ID2TX;
        r_tx_buf_size_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlArrayU8Size_Mod1CAN0ID1TX;

        r_rx_buf_id1_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorArrayU8_Mod1CAN0ID1RX;
        r_rx_buf_id2_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorArrayU8_Mod1CAN0ID2RX;
        r_rx_buf_size_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorArrayU8Size_Mod1CAN0ID1RX;

        r_CAN_transmit_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlBool_MOD1CAN0Transmit;
        r_CAN_complete_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod1CAN0Complete;
        r_CAN_success_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod1CAN0success;
        r_CAN_complete_counter_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorI16_Mod1CAN0CompleteCounter;

        r_tx_timeout_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod1CAN0TXTimeout;
        r_rx_timeout_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod1CAN0RXTimeout;

        r_timeout_us_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlU32_Mod1CAN0RXTimeoutus;
    }
    else if (CAN_port_ == "MOD1CAN1")
    {
        ...
        r_tx_buf_id1_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlArrayU8_Mod1CAN1ID1TX;
        r_tx_buf_id2_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlArrayU8_Mod1CAN1ID2TX;
        r_tx_buf_size_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlArrayU8Size_Mod1CAN1ID1TX;

        r_rx_buf_id1_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorArrayU8_Mod1CAN1ID1RX;
        r_rx_buf_id2_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorArrayU8_Mod1CAN1ID2RX;
        r_rx_buf_size_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorArrayU8Size_Mod1CAN1ID1RX;

        r_CAN_transmit_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlBool_MOD1CAN1Transmit;
        r_CAN_complete_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod1CAN1Complete;
        r_CAN_success_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod1CAN1success;
        r_CAN_complete_counter_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorI16_Mod1CAN1CompleteCounter;

        r_tx_timeout_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod1CAN1TXTimeout;
        r_rx_timeout_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod1CAN1RXTimeout;

        r_timeout_us_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlU32_Mod1CAN1RXTimeoutus;
    }
    else if (CAN_port_ == "MOD2CAN0")
    {
        ...
        r_tx_buf_id1_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlArrayU8_Mod2CAN0ID1TX;
        r_tx_buf_id2_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlArrayU8_Mod2CAN0ID2TX;
        r_tx_buf_size_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlArrayU8Size_Mod2CAN0ID1TX;

        r_rx_buf_id1_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorArrayU8_Mod2CAN0ID1RX;
        r_rx_buf_id2_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorArrayU8_Mod2CAN0ID2RX;
        r_rx_buf_size_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorArrayU8Size_Mod2CAN0ID1RX;

        r_CAN_transmit_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlBool_MOD2CAN0Transmit;
        r_CAN_complete_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod2CAN0Complete;
        r_CAN_success_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod2CAN0success;
        r_CAN_complete_counter_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorI16_Mod2CAN0CompleteCounter;

        r_tx_timeout_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod2CAN0TXTimeout;
        r_rx_timeout_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod2CAN0RXTimeout;

        r_timeout_us_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlU32_Mod2CAN0RXTimeoutus;
    }
    else if (CAN_port_ == "MOD2CAN1")
    {
        ...
        r_tx_buf_id1_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlArrayU8_Mod2CAN1ID1TX;
        r_tx_buf_id2_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlArrayU8_Mod2CAN1ID2TX;
        r_tx_buf_size_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlArrayU8Size_Mod2CAN1ID1TX;

        r_rx_buf_id1_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorArrayU8_Mod2CAN1ID1RX;
        r_rx_buf_id2_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorArrayU8_Mod2CAN1ID2RX;
        r_rx_buf_size_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorArrayU8Size_Mod2CAN1ID1RX;

        r_CAN_transmit_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlBool_MOD2CAN1Transmit;
        r_CAN_complete_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod2CAN1Complete;
        r_CAN_success_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod2CAN1success;
        r_CAN_complete_counter_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorI16_Mod2CAN1CompleteCounter;

        r_tx_timeout_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod2CAN1TXTimeout;
        r_rx_timeout_ = NiFpga_FPGA_CANBus_4module_v3_steering_IndicatorBool_Mod2CAN1RXTimeout;

        r_timeout_us_ = NiFpga_FPGA_CANBus_4module_v3_steering_ControlU32_Mod2CAN1RXTimeoutus;
    }
    else
    {
...
void ModuleIO::CAN_send_command(CAN_txcmd txdata_id1, CAN_txcmd txdata_id2)
{
    ...
    CAN_cmd_encode(txmsg_id1, txdata1_biased);
    CAN_cmd_encode(txmsg_id2, txdata2_biased);
...
void ModuleIO::CAN_send_config(CAN_txconfig txconfig_id1, CAN_txconfig txconfig_id2)
{
    ...
    CAN_config_encode(txmsg_id2, txconfig_id2);
    write_tx_data_(txmsg_id1, txmsg_id2);
    usleep(100);
    write_CAN_transmit_(1);
}
...
void ModuleIO::CAN_recieve_feedback(CAN_rxcmd *rxdata_id1, CAN_rxcmd *rxdata_id2)
{
    ...
    CAN_cmd_decode(rxmsg_id1, rxdata_id1);
    CAN_cmd_decode(rxmsg_id2, rxdata_id2);
...
// pack CAN data
void ModuleIO::CAN_cmd_encode(uint8_t (&txmsg)[8], CAN_txcmd txdata)
{
...
{
    // [0]: Config type (READ/WRITE)
    txmsg[0] = static_cast<uint8_t>(txconfig.config_type_);
    
    // [1]: Data type (INT/FLOAT)
    txmsg[1] = static_cast<uint8_t>(txconfig.data_type_);
